...
func TestParseAuthClaims(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			claims:      jwt.MapClaims{"team_id": 123., "api_token": "token123", "organization_id": "org-1"},
			expectError: "invalid user_id",
		},
		{
			name:        "Missing organization_id",
			claims:      jwt.MapClaims{"team_id": 123., "api_token": "token123", "user_id": 42.},
			expectError: "invalid organization_id",
		},
		{
