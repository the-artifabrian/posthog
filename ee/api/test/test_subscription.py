...
from posthog.temporal.subscriptions.subscription_scheduling_workflow import DeliverSubscriptionWorkflowInputs
...
class TestSubscriptionTemporal(APILicensedTest):
    ...
    def test_can_create_new_subscription(self, mock_sync):
        ...
        assert isinstance(activity_inputs, DeliverSubscriptionWorkflowInputs)
